                    ...
                    <div class="form_padrao">
                        @if($group && !$mission )
                            <form action="" id="inscricao" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="title" value="todo-mundo">
                                <input type="hidden" name="code" value="{{$missionEnum->value}}">
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_1">Listem pessoas e/ou organizações que podem ajudar no desenvolvimento do projeto.</label>
                                ...
                                <div class="form-group tipo" id="tipo-video">
                                    <label for="video">Crie um vídeo de até 2 minutos convidando as pessoas e/ou organizações que mais podem ajudar na realização do projeto.</label>
