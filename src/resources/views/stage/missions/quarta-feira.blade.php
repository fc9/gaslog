                    ...
                    <div class="form_padrao">
                        @if($group && !$mission )
                            <form action="" id="inscricao" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="title" value="no-grupo">
                                <input type="hidden" name="code" value="{{$missionEnum->value}}">
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_1">
                                        Descreva as ações do projeto, citando quais já estão sendo realizadas e quais ainda serão feitas pelo grupo.
                                    </label>
                                ...
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_2">Quais os objetivos que o grupo pretende atingir com essas ações?</label>
