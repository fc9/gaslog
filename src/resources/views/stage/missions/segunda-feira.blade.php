                    ...
                    <div class="form_padrao">
                        @if($group && !$mission)
                            <form action="" id="inscricao" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="title" value="no-probleminha">
                                <input type="hidden" name="code" value="{{$missionEnum->value}}">
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_1">
                                        Qual foi a questão ou problema escolhido pelos(as) estudantes para ser resolvido ou melhorado com o plano de ação?
                                    </label>
                                ...
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_2">Como e por que o grupo escolheu esta questão ou problema?</label>
                                ...
                                <div class="form-group tipo" id="tipo-texto">
                                    <label for="text_field_3">
                                        Crie um slogan do grupo em até 4 palavras
                                        <small>(Exemplos: Todos contra os preconceitos, Cuidando da nossa cidade, entre outros)</small>
                                    </label>
                                    <textarea name="text_field_3" cols="30" rows="10" placeholder="" id="text_field_3"
                                            {{$group && !$mission ? 'required': 'disabled'}}>{{ $mission ? $mission->text_field_2 : '' }}</textarea>
                                </div>
