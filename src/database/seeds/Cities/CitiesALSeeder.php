...
class CitiesALSeeder extends Seeder {
    ...
    public function run() {
        ...
        $cities = [
            ...
            'Belo Monte', 'Boca da Mata', 'Branquinha', 'Cacimbinhas',
            ...
            'Jacuípe', 'Japaratinga', 'Jaramataia', 'Jequiá da Praia',
            'Joaquim Gomes', 'Jundiá', 'Junqueiro', 'Lagoa da Canoa',
            'Limoeiro de Anadia', 'Maceió', 'Major Isidoro', 'Maragogi',
            'Maravilha', 'Marechal Deodoro', 'Maribondo', 'Mar Vermelho',
